        ...
        if "TABLE" in str(fle):
            ...
            for (va, sle) in sl:
                if "TABLE" in str(sle):
                    ...
                    lib.pt64.parse_pt(tl, va, tnsz, 3)
